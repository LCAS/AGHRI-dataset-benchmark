...
def train_and_eval_model(model_item: Dict[str, Any], bench_cfg: Dict[str, Any], repo_root: Path) -> Dict[str, Any]:
    ...
    summary = {
        ...
        'kitti_3d_ap_easy': _to_float(_metric_get(metrics, 'kitti_3d_ap_easy')),
        'kitti_3d_ap_moderate': _to_float(_metric_get(metrics, 'kitti_3d_ap_moderate')),
        'kitti_3d_ap_hard': _to_float(_metric_get(metrics, 'kitti_3d_ap_hard')),
        'kitti_bev_ap_easy': _to_float(_metric_get(metrics, 'kitti_bev_ap_easy')),
        'kitti_bev_ap_moderate': _to_float(_metric_get(metrics, 'kitti_bev_ap_moderate')),
        'kitti_bev_ap_hard': _to_float(_metric_get(metrics, 'kitti_bev_ap_hard')),
        'kitti_3d_recall_easy': _to_float(_metric_get(metrics, 'kitti_3d_recall_easy')),
        'kitti_3d_recall_moderate': _to_float(_metric_get(metrics, 'kitti_3d_recall_moderate')),
        'kitti_3d_recall_hard': _to_float(_metric_get(metrics, 'kitti_3d_recall_hard')),
