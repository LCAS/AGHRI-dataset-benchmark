...
- Combination ID: `P1`
- Combination: G YOLO + G PointPillars
...
- Tracks created: 146
- Confirmed tracks: 16
- Mean confirmed-track length: 21.44
- Maximum track length: 73
- Prediction-only updates: 507
- Deleted tracks: 144
- Tracker-only FPS: 1408.85
- Cached-pipeline FPS: 1116.94
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P1/footpath1_p1_nj+mk+gl_1walk+check_mv_11_12_2024_1_label/visual_frames`
