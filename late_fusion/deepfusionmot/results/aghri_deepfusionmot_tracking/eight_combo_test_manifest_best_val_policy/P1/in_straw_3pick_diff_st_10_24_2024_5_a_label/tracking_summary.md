...
- Tracks created: 33
- Confirmed tracks: 2
- Mean confirmed-track length: 18.50
- Maximum track length: 26
- Prediction-only updates: 46
- Deleted tracks: 33
- Tracker-only FPS: 1034.12
- Cached-pipeline FPS: 969.07
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P1/in_straw_3pick_diff_st_10_24_2024_5_a_label/visual_frames`
