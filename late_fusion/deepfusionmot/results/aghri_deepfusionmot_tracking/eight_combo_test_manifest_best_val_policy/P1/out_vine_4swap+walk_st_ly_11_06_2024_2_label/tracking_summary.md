...
- Tracks created: 119
- Confirmed tracks: 13
- Mean confirmed-track length: 18.92
- Maximum track length: 90
- Prediction-only updates: 226
- Deleted tracks: 118
- Tracker-only FPS: 2082.80
- Cached-pipeline FPS: 1219.93
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P1/out_vine_4swap+walk_st_ly_11_06_2024_2_label/visual_frames`
