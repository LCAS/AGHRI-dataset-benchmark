...
- LiDAR detections: 99
- Score-filtered LiDAR detections before NMS: 99
- NMS-suppressed LiDAR detections: 0
- Fused detections: 89
- Tracks created: 17
- Confirmed tracks: 4
- Mean confirmed-track length: 24.75
- Maximum track length: 43
- Prediction-only updates: 74
- Deleted tracks: 16
- Tracker-only FPS: 1511.08
- Cached-pipeline FPS: 1359.73
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P2/footpath1_p1_oj+mk+gl_1walk+check_st_11_12_2024_1_label/visual_frames`
