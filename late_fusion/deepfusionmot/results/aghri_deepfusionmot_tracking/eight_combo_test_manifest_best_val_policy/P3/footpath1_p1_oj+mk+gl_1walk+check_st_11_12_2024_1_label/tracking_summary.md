...
- Tracks created: 4
- Confirmed tracks: 4
- Mean confirmed-track length: 44.25
- Maximum track length: 59
- Prediction-only updates: 31
- Deleted tracks: 3
- Tracker-only FPS: 3667.99
- Cached-pipeline FPS: 1346.12
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P3/footpath1_p1_oj+mk+gl_1walk+check_st_11_12_2024_1_label/visual_frames`
