...
- Camera detections: 1142
- LiDAR detections: 1018
- Score-filtered LiDAR detections before NMS: 1018
- NMS-suppressed LiDAR detections: 0
- Fused detections: 909
- Tracks created: 14
- Confirmed tracks: 11
- Mean confirmed-track length: 91.18
- Maximum track length: 265
- Prediction-only updates: 121
- Deleted tracks: 10
- Tracker-only FPS: 2070.73
- Cached-pipeline FPS: 979.77
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P3/out_vine_4swap+walk_st_ly_11_06_2024_2_label/visual_frames`
