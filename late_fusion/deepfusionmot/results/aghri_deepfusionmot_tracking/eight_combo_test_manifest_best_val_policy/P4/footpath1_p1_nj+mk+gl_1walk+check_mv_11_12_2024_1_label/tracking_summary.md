...
- Combination ID: `P4`
- Combination: FT YOLO + FT PointPillars
- Recording used: `footpath1_p1_nj+mk+gl_1walk+check_mv_11_12_2024_1_label`
- Frames processed: 249
- Camera model: `finetuned`
- LiDAR detector: `pointpillars`
- LiDAR model: `finetuned`
...
- LiDAR cache: `/home/prabuddhi/Desktop/late_fusion/deepfusionmot/results/aghri_pointpillars_detector_comparison/cache/pointpillars_finetuned/detections.csv`
...
- Ego motion source: `/media/prabuddhi/Backup2/Updated Dataset_PW/dataset_part1/footpath1_p1_nj+mk+gl_1walk+check_mv_11_12_2024_1_label/metadata/odom_global.jsonl`
- Ego motion applied frames: 248
- Camera detections: 201
- LiDAR detections: 228
- Score-filtered LiDAR detections before NMS: 228
- NMS-suppressed LiDAR detections: 0
- Fused detections: 198
- Tracks created: 7
- Confirmed tracks: 4
- Mean confirmed-track length: 54.25
- Maximum track length: 106
- Prediction-only updates: 31
- Deleted tracks: 6
- Tracker-only FPS: 4502.14
- Cached-pipeline FPS: 1668.80
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P4/footpath1_p1_nj+mk+gl_1walk+check_mv_11_12_2024_1_label/visual_frames`
