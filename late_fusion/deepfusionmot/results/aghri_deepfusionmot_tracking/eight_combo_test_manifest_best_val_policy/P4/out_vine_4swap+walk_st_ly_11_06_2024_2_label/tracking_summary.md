...
- Recording used: `out_vine_4swap+walk_st_ly_11_06_2024_2_label`
...
- Ego motion source: `/media/prabuddhi/Backup2/Updated Dataset_PW/dataset_part4/out_vine_4swap+walk_st_ly_11_06_2024_2_label/metadata/odom_global.jsonl`
- Ego motion applied frames: 272
- Camera detections: 986
- LiDAR detections: 1018
- Score-filtered LiDAR detections before NMS: 1018
- NMS-suppressed LiDAR detections: 0
- Fused detections: 926
- Tracks created: 14
- Confirmed tracks: 11
- Mean confirmed-track length: 92.18
- Maximum track length: 268
- Prediction-only updates: 109
- Deleted tracks: 11
- Tracker-only FPS: 2301.70
- Cached-pipeline FPS: 1039.67
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P4/out_vine_4swap+walk_st_ly_11_06_2024_2_label/visual_frames`
