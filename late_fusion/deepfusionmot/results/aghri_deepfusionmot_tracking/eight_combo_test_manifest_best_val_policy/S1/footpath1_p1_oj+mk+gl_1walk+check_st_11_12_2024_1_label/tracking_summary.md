...
- Tracks created: 10
- Confirmed tracks: 4
- Mean confirmed-track length: 31.50
- Maximum track length: 48
- Prediction-only updates: 47
- Deleted tracks: 9
- Tracker-only FPS: 1544.64
- Cached-pipeline FPS: 1375.40
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S1/footpath1_p1_oj+mk+gl_1walk+check_st_11_12_2024_1_label/visual_frames`
