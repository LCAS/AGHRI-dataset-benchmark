...
- Tracks created: 10
- Confirmed tracks: 4
- Mean confirmed-track length: 31.75
- Maximum track length: 49
- Prediction-only updates: 46
- Deleted tracks: 9
- Tracker-only FPS: 1531.61
- Cached-pipeline FPS: 1362.97
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S2/footpath1_p1_oj+mk+gl_1walk+check_st_11_12_2024_1_label/visual_frames`
