...
- LiDAR detections: 100
- Score-filtered LiDAR detections before NMS: 100
- NMS-suppressed LiDAR detections: 0
- Fused detections: 54
- Tracks created: 17
- Confirmed tracks: 6
- Mean confirmed-track length: 23.00
- Maximum track length: 63
- Prediction-only updates: 71
- Deleted tracks: 15
- Tracker-only FPS: 1258.48
- Cached-pipeline FPS: 652.49
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S2/out_vine_1push_3carry_st_ly_11_06_2024_1_label/visual_frames`
