...
- Fused detections: 316
- Tracks created: 29
- Confirmed tracks: 25
- Mean confirmed-track length: 24.16
- Maximum track length: 126
- Prediction-only updates: 359
- Deleted tracks: 28
- Tracker-only FPS: 2047.01
- Cached-pipeline FPS: 1084.59
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S3/out_vine_4swap+walk_st_ly_11_06_2024_2_label/visual_frames`
