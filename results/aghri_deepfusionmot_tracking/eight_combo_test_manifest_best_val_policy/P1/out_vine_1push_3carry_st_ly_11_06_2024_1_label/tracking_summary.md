...
- Tracks created: 54
- Confirmed tracks: 9
- Mean confirmed-track length: 19.22
- Maximum track length: 71
- Prediction-only updates: 152
- Deleted tracks: 51
- Tracker-only FPS: 1675.50
- Cached-pipeline FPS: 803.10
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P1/out_vine_1push_3carry_st_ly_11_06_2024_1_label/visual_frames`
