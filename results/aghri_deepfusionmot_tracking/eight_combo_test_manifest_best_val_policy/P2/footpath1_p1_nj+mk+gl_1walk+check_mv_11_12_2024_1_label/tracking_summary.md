...
- Combination ID: `P2`
- Combination: FT YOLO + G PointPillars
...
- LiDAR cache: `/home/prabuddhi/Desktop/late_fusion/deepfusionmot/results/aghri_pointpillars_detector_comparison/cache/pointpillars_generic/detections.csv`
...
- LiDAR detections: 468
- Score-filtered LiDAR detections before NMS: 468
- NMS-suppressed LiDAR detections: 0
- Fused detections: 89
- Tracks created: 146
- Confirmed tracks: 16
- Mean confirmed-track length: 21.50
- Maximum track length: 73
- Prediction-only updates: 507
- Deleted tracks: 144
- Tracker-only FPS: 1516.29
- Cached-pipeline FPS: 1227.73
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/P2/footpath1_p1_nj+mk+gl_1walk+check_mv_11_12_2024_1_label/visual_frames`
