...
- LiDAR detections: 233
- Score-filtered LiDAR detections before NMS: 233
- NMS-suppressed LiDAR detections: 0
- Fused detections: 204
- Tracks created: 28
- Confirmed tracks: 14
- Mean confirmed-track length: 31.14
- Maximum track length: 87
- Prediction-only updates: 199
- Deleted tracks: 27
- Tracker-only FPS: 2094.34
- Cached-pipeline FPS: 1202.07
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S1/out_vine_4swap+walk_st_ly_11_06_2024_2_label/visual_frames`
