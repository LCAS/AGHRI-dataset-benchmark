...
- Tracks created: 63
- Confirmed tracks: 5
- Mean confirmed-track length: 31.00
- Maximum track length: 81
- Prediction-only updates: 80
- Deleted tracks: 62
- Tracker-only FPS: 1646.14
- Cached-pipeline FPS: 1412.63
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S2/footpath1_p1_nj+mk+gl_1walk+check_mv_11_12_2024_1_label/visual_frames`
