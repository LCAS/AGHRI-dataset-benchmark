...
- Tracks created: 11
- Confirmed tracks: 3
- Mean confirmed-track length: 12.00
- Maximum track length: 29
- Prediction-only updates: 39
- Deleted tracks: 10
- Tracker-only FPS: 3041.60
- Cached-pipeline FPS: 986.45
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S2/in_straw_3pick_diff_st_10_24_2024_5_a_label/visual_frames`
