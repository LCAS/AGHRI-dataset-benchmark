...
- Fused detections: 205
- Tracks created: 28
- Confirmed tracks: 16
- Mean confirmed-track length: 33.81
- Maximum track length: 88
- Prediction-only updates: 242
- Deleted tracks: 26
- Tracker-only FPS: 1272.63
- Cached-pipeline FPS: 790.86
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S2/out_vine_4swap+walk_st_ly_11_06_2024_2_label/visual_frames`
