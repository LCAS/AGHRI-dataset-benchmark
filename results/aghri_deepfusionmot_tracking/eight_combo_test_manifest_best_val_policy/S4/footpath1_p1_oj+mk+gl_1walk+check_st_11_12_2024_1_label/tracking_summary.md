...
- LiDAR detections: 97
- Score-filtered LiDAR detections before NMS: 97
- NMS-suppressed LiDAR detections: 0
- Fused detections: 97
- Tracks created: 5
- Confirmed tracks: 5
- Mean confirmed-track length: 32.00
- Maximum track length: 48
- Prediction-only updates: 55
- Deleted tracks: 4
- Tracker-only FPS: 2694.55
- Cached-pipeline FPS: 1159.05
...
- Visual frames directory: `results/aghri_deepfusionmot_tracking/eight_combo_test_manifest_best_val_policy/S4/footpath1_p1_oj+mk+gl_1walk+check_st_11_12_2024_1_label/visual_frames`
